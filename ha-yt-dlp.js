 ...
 * Bundled as ha-yt-dlp.js for HACS (repository name must match filename).
 * Source: frontend/ha-card/yt-dlp-card.js
 *
 * Config: api_url, title, max_tasks. Type in Lovelace: custom:yt-dlp-card
 */
